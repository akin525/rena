                                ...
                                <div class="widget-card">
                                    <div class="media align-self-center">
                                        ...
                                        <div class="media-body">
                                            ...
                                            <h5><span class="counter">{{ number_format($tt) ?? 'Total Transactions' }}</span></h5>
                                        </div>
                                    </div>
                                </div>
                            </div>
            ...
            <div class="col-sm-6 col-xl-3 col-lg-6">
                <div class="card o-hidden">
                    <div class="card-body">
                        <div class="media static-widget">
                            <div class="media-body">
                                <h6 class="font-roboto">Sum Of Today Transactions</h6>
            ...
            <div class="col-sm-6 col-xl-3 col-lg-6">
                <div class="card o-hidden">
                    <div class="card-body">
                        <div class="media static-widget">
                            <div class="media-body">
                                <h6 class="font-roboto">Sum Of  Yesterday Transactions</h6>
            ...
            <div class="col-sm-6 col-xl-3 col-lg-6">
                <div class="card o-hidden">
                    <div class="card-body">
                        <div class="media static-widget">
                            <div class="media-body">
                                <h6 class="font-roboto">Sum Of Total Transactions 2Days Ago</h6>
