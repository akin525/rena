                    ...
                    <div class="card-body">
                        ...
                        @foreach($product as $seller)
                            <tr>
                                ...
                                <td>
                                    <label class="switch">
                                        <input type="checkbox" name="status" value="0" id="myCheckBox"
                                               ...
                                               onclick="window.location='{{route('pd1', $seller->id)}}'"/>
                                ...
                                <td>
                                    <a href="{{route('editproduct1', $seller->id)}}" class="btn btn-outline-primary"><i class="fa fa-edit"></i></a>
                                </td>
                            </tr>
                        @endforeach
                                </tbody>
