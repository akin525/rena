                                ...
                                <div class="table-responsive">
                                    <table class="table table-bordered">
                                        ...
                                        @foreach($server as $seller)
                                            <tr>
                                                <td class="pills-component">@if($seller->name=="mcd")
                                                        <img width="50" src="{{asset('tar.png')}}"/>
                                                    @elseif($seller->name=="easyaccess")
                                                        <img width="50" src="{{asset('es.png')}}"/>

                                                    @elseif($seller->name=="datahouse")
                                                        <img width="50" src="{{asset('da.png')}}"/>
                                                    @else
                                                ...
                                                <td class="w-50">
                                                    <label class="switch">
                                                        <input type="checkbox"  value="0"
                                                               ...
                                                               onclick="window.location='{{route('up', $seller->id)}}'"
                                                        />
